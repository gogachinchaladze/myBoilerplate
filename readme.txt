...
1) Put all the libraries (jquery, three etc.) into resources/js/lib folder
2) Write rest of the code into resources/js/main.js
3) Run "npm install" to install all the dependencies
6) Run "gulp" to start watching the files
...
To run php files on localhost run this command in terminal (in project folder):
